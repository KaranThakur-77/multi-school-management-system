                                ...
                                @csrf
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="form-floating mb-3">
                                                <input type="text" class="form-control  @error('username') is-invalid   @enderror " value="{{old('username')}}" name="username" id="usernaem" placeholder="Lorem Ipsum." >
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-warning py-3" type="submit">Register Now</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
